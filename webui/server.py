"""
Lightweight API server for the SWE-Lego-Live-SFT training dashboard.
...
Usage:
  python server.py                          # auto-detect ../saves and ../logs
...
def main():
    p = argparse.ArgumentParser(description="SWE-Lego-Live-SFT Training Dashboard Server")
    ...
    save_dir = args.save_dir or _default("saves")
    log_dir = args.log_dir or _default("logs")
    ...
    print(f"SWE-Lego-Live-SFT Dashboard on http://{args.host}:{args.port}")
